...
const CASES: ParityCase[] = [
  {
    ...
    pythonCorrect: "def twoSum(nums, target):\n    seen = {}\n    for i, x in enumerate(nums):\n        if target - x in seen:\n            return [seen[target - x], i]\n        seen[x] = i\n    return []\n",
    cppCorrect:
      "class Solution {\npublic:\n" +
  ...
  },
  {
    ...
    tests: [{ args: [[1, 2, 3, 4]], expected: [[1, 2], [3, 4]] }],
    comparator: { kind: "unordered" },
    pythonCorrect: "def pairSums(nums):\n    return [[nums[i], nums[i+1]] for i in range(0, len(nums), 2)]\n",
    cppCorrect:
      "class Solution {\npublic:\n" +
  ...
  },
  {
    ...
    cppWrong: "class Solution {\npublic:\n    std::string reverseString(std::string s) { return s; }\n};\n",
    expectedCorrectVerdict: "accepted",
    expectedWrongVerdict: "wrong_answer",
  },
  {
    name: "float_tol (float -> float)",
    signature: { name: "average", params: [{ name: "a", type: "float" }, { name: "b", type: "float" }], returns: "float" },
    tests: [
  ...
  },
  {
    ...
    signature: { name: "invertTree", params: [{ name: "root", type: "TreeNode?" }], returns: "TreeNode?" },
    tests: [
  ...
  },
  {
    ...
    signature: { name: "reverseList", params: [{ name: "head", type: "ListNode?" }], returns: "ListNode?" },
    tests: [
