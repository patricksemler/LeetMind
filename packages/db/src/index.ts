// @algolift/db — pg pool, migration runner, and a thin parameterized-SQL repository layer.
...
// programmatically from testSchema.ts, so it needs to be reachable as `@algolift/db`, not just
