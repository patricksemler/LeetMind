...
DEFAULT_TEST_DATABASE_URL = "postgres://algolift:algolift@localhost:5432/algolift_test"
...
def assert_test_database(url: str) -> None:
    ...
    if not db_name:
        raise RuntimeError(
            ...
            '"postgres://algolift:algolift@localhost:5432/algolift_test".'
        )
...
# colliding with EACH OTHER inside the *same* `algolift_test` database — both truncating the same
