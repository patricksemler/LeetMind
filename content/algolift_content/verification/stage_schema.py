...
enforced by `ProblemVersion`'s own pydantic validators (`algolift_content.models`), so a pydantic
...
from algolift_content.models import ProblemVersion, StageResult
