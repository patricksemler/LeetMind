...
Derives boundary cases from `constraints_md` (`leetmind_content.verification.constraints`) and
...
from leetmind_content.verification.constraints import Bound, coupled_scalars, parse_bounds
