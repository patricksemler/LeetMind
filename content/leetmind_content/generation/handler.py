...
`leetmind_content.workers.content_worker` (see that module's "SEAM FOR FOLLOW-UP AGENTS" docstring
— replace `HANDLERS["generate"]` with `leetmind_content.generation.handler.handle_generate`).

Import path for wiring: `leetmind_content.generation.handler.handle_generate`.
"""

from __future__ import annotations

from leetmind_content.generation.generator import GenerationSchemaExhausted, generate_problem
from leetmind_content.logging import get_logger
from leetmind_content.models import GenerateJobPayload
