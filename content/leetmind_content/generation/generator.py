...
`leetmind_content.generation.handler.handle_generate` must treat them completely differently:
...
from leetmind_content.db import get_pool, query, transaction
from leetmind_content.generation.envelope import EnvelopeError, parse_envelope
from leetmind_content.generation.invoker import Invoker, InvokeResult, get_invoker
...
from leetmind_content.models import GenerationRequest, ModelRun, ProblemVersion
