 ...
 * is a hidden one. See `FailingTestSchema` in @shared for why the hidden case is served at
 * all, and for the bound on it (one case per submission, never the suite).
 */
import type { Submission, PublicProblem } from "@shared";
 ...
 * (`SUBMISSION_HISTORY_LIMIT`, server-side) so unfinished attempts, which are filtered out below,
